              ...
              {[
                ...
                <div key={field.name}>
                  ...
                  <input
                    ...
                    name={field.name}
                    value={
                      additionalInfo[field.name as keyof typeof additionalInfo]
                    }
...
//   const handleSubmit = async (e: FormEvent) => {
//     e.preventDefault();
//     const { id, name, category, rating, price, discount,warranty, stock, description, image, images } = product;

//     if (!id || !name || !category || !rating || !price || !description || !image || !discount || warranty || stock) {
//       alert("Please fill all required fields.");
//       return;
//     }
