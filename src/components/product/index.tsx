        ...
        <div className="w-full lg:w-3/4 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <input
              ...
              className="w-full sm:w-1/2 rounded-md  px-4 py-2 text-gray-700 placeholder:text-gray-400 focus:border-red-500 focus:ring-2 focus:ring-red-200 outline-none"
            />
